            ...
            <div class="container-fluid justify-content-between d-flex pe-3">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 px-4 text-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-inline-block px-2 mx-3 pointer" href="./articles.html">Tutti gli
                                annunci</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-inline-block px-2 mx-3 pointer" href="#">Profilo</a>
                        </li>
...
>>>>>>> 2ff2e668c8a64c2bc28a44aae3512e1859b86e78
